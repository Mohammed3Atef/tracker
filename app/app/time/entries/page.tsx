...
import { Plus, Search, Filter, Calendar, Edit, Trash2, Play, Square, Coffee } from "lucide-react";
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">View and manage all time entries</p>
        </div>
      ...
      <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Create a new time entry</DialogDescription>
          </DialogHeader>
